...
# gpt4all_path = 'ggml-model-gpt4all-falcon-q4_0.bin' 
# emb_path = 'ggml-all-MiniLM-L6-v2-f16.bin' 

# callback_manager = BaseCallbackManager([StreamingStdOutCallbackHandler()])
# loader = TextLoader("./docs/state_of_the_union.txt")
# embeddings = GPT4AllEmbeddings(model_path=emb_path)
...
# # index.save_local("state_of_the_union_full_index")
...
# index = FAISS.load_local("./state_of_the_union_full_index", embeddings)
